...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"API_URL\": () => (/* binding */ API_URL),\n/* harmony export */   \"postData\": () => (/* binding */ postData)\n/* harmony export */ });\nconst API_URL = 'https://us-central1-js-capstone-backend.cloudfunctions.net/api/games/9r8y77GrUc6tYpR94O07/scores/';\n\nconst postData = (url, data = {}) => fetch(url, {\n  method: 'POST',\n  headers: {\n    'Content-Type': 'application/json',\n  },\n  body: JSON.stringify(data),\n});\n\n\n//# sourceURL=webpack://Leaderboard/./src/api.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _board_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./board.js */ \"./src/board.js\");\n/* harmony import */ var _elements_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./elements.js */ \"./src/elements.js\");\n\n\n\nconst onready = async () => {\n  await (0,_board_js__WEBPACK_IMPORTED_MODULE_0__.getScores)();\n\n  _elements_js__WEBPACK_IMPORTED_MODULE_1__.Elements.form.addEventListener('submit', _board_js__WEBPACK_IMPORTED_MODULE_0__.postScore);\n\n  _elements_js__WEBPACK_IMPORTED_MODULE_1__.Elements.refresh.addEventListener('click', _board_js__WEBPACK_IMPORTED_MODULE_0__.getScores);\n};\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (onready);\n\n\n//# sourceURL=webpack://Leaderboard/./src/app.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"getScores\": () => (/* binding */ getScores),\n/* harmony export */   \"postScore\": () => (/* binding */ postScore)\n/* harmony export */ });\n/* harmony import */ var _api_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./api.js */ \"./src/api.js\");\n/* harmony import */ var _elements_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./elements.js */ \"./src/elements.js\");\n\r\n\r\n\r\nconst renderScore = ({ user, score }) => {\r\n  const element = document.createElement('li');\r\n  element.textContent = `${user}: ${score}`;\r\n\r\n  return element;\r\n};\r\n\r\nconst sortByHighestScore = ({ score: a }, { score: b }) => b - a;\r\n\r\nconst getAdjacentSibling = ({ score }) => Array.from(_elements_js__WEBPACK_IMPORTED_MODULE_1__.Elements.scoreList.children).find(\r\n  ({ textContent }) => score > parseInt(textContent.split(':').pop(), 10),\r\n);\r\n\r\nconst flagTrigger = (trigger) => {\r\n  const { disabled = false } = trigger;\r\n  trigger.disabled = !disabled;\r\n\r\n  (0,_elements_js__WEBPACK_IMPORTED_MODULE_1__.$select)('span', trigger).classList.toggle('hidden');\r\n  (0,_elements_js__WEBPACK_IMPORTED_MODULE_1__.$select)('.lds-dots', trigger).classList.toggle('hidden');\r\n};\r\n\r\nconst populateScore = ({ result: scores }) => {\r\n  const list = _elements_js__WEBPACK_IMPORTED_MODULE_1__.Elements.scoreList;\r\n  scores.sort(sortByHighestScore).forEach((player) => list.appendChild(renderScore(player)));\r\n  flagTrigger(_elements_js__WEBPACK_IMPORTED_MODULE_1__.Elements.refresh);\r\n};\r\n\r\nasync function postScore(evt) {\r\n  evt.preventDefault();\r\n  flagTrigger(_elements_js__WEBPACK_IMPORTED_MODULE_1__.Elements.submit);\r\n\r\n  const player = {\r\n    user: this.elements.user.value,\r\n    score: parseInt(this.elements.score.value, 10),\r\n  };\r\n  const response = await (0,_api_js__WEBPACK_IMPORTED_MODULE_0__.postData)(_api_js__WEBPACK_IMPORTED_MODULE_0__.API_URL, player);\r\n  const { result } = await response.json();\r\n\r\n  if (result === 'Leaderboard score created correctly.') {\r\n    this.reset();\r\n\r\n    const adjacentSibling = getAdjacentSibling(player);\r\n    const newSibling = renderScore(player);\r\n\r\n    if (adjacentSibling === null) _elements_js__WEBPACK_IMPORTED_MODULE_1__.Elements.scoreList.appendChild(newSibling);\r\n\r\n    else adjacentSibling.insertAdjacentElement('beforebegin', newSibling);\r\n  }\r\n\r\n  flagTrigger(_elements_js__WEBPACK_IMPORTED_MODULE_1__.Elements.submit);\r\n}\r\n\r\nconst getScores = async () => {\r\n  flagTrigger(_elements_js__WEBPACK_IMPORTED_MODULE_1__.Elements.refresh);\r\n  _elements_js__WEBPACK_IMPORTED_MODULE_1__.Elements.scoreList.innerHTML = '';\r\n  const response = await fetch(_api_js__WEBPACK_IMPORTED_MODULE_0__.API_URL);\r\n  const result = await response.json();\r\n\r\n  populateScore(result);\r\n};\r\n\n\n//# sourceURL=webpack://Leaderboard/./src/board.js?");
